    ...
    try {
      ...
      if ('mediaSession' in navigator) {
        ...
        const artwork = track.coverUrl
          ? [
              { src: track.coverUrl, sizes: '96x96',   type: imgType },
              { src: track.coverUrl, sizes: '128x128',  type: imgType },
              { src: track.coverUrl, sizes: '192x192',  type: imgType },
              { src: track.coverUrl, sizes: '256x256',  type: imgType },
