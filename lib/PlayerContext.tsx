      ...
      {currentTrack && (
        ...
        >
          <div className="max-w-2xl mx-auto pointer-events-auto">
            ...
            {/* Waveform + seek — estilo untitled */}
            <div
              className="px-3 mb-[-2px] relative h-10 flex items-end cursor-pointer select-none"
              style={{ gap: '2px' }}
              onClick={(e) => {
                if (!duration) return
            ...
            >
              ...
              {/* Línea de progreso vertical — estilo untitled */}
              <div
                className="absolute top-0 bottom-0 w-[2px] bg-white pointer-events-none"
                style={{ left: `calc(${progressPct * 100}% + 12px)`, transition: 'left 0.1s linear' }}
              />
            </div>
