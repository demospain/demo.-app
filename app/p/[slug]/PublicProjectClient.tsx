                  ...
                  return (
                    ...
                    >
                      {isLoadingTrack ? (
                        ...
                        <div className="w-5 flex items-end justify-center gap-[2px] h-4 flex-shrink-0">
                          {[1, 0.5, 0.8, 0.3].map((h, idx) => (
                            <div
                              key={idx}
                              className="w-[3px] rounded-full bg-[#7C6FFF]"
                              style={{
                                height: `${h * 100}%`,
                                animation: `waveBar 0.8s ease-in-out ${idx * 0.15}s infinite alternate`,
                              }}
                            />
                          ))}
                        </div>
                        ...
                        <div className="w-5 flex items-end justify-center gap-[2px] h-4 flex-shrink-0">
                          {[1, 0.5, 0.8, 0.3].map((h, idx) => (
                            <div key={idx} className="w-[3px] rounded-full bg-[#7C6FFF]/50" style={{ height: `${h * 100}%` }}/>
                          ))}
                        </div>
                      ) : (
