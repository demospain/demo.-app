...
export default async function DashboardPage() {
  ...
  // Aplanar los proyectos guardados al mismo tipo que Project
  ...
  // Recoger owner_ids únicos de proyectos guardados para buscar sus nombres
  const ownerIds = Array.from(new Set(savedProjects.map(p => p.owner_id).filter(Boolean))) as string[]
