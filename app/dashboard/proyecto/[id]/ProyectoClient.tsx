...
export default function ProyectoClient({ project: initialProject, initialTracks, isMine, userId, nombre, inicial }: Props) {
  ...
  return (
    <div className={`flex flex-col min-h-screen ${currentTrack ? 'pb-20' : ''}`}>
      ...
      {/* Navbar */}
      <nav className="h-[60px] border-b border-white/[0.05] flex items-center justify-between px-6 sticky top-0 z-50 bg-[#0d0d0f]/95 backdrop-blur-md">
        <div className="flex items-center gap-3 min-w-0">
          <button
            onClick={() => router.push('/dashboard')}
            className="w-10 h-10 rounded-xl bg-[#1E2028] hover:bg-[#252830] border border-white/[0.06] flex items-center justify-center transition-colors flex-shrink-0"
          >
        ...
        <div className="flex items-center gap-2">
          {showSearch ? (
            <div className="flex items-center gap-2 bg-[#1E2028] border border-white/[0.08] rounded-xl px-3 h-10">
            ...
            <button
              ...
              className="w-10 h-10 rounded-xl bg-[#1E2028] hover:bg-[#252830] border border-white/[0.06] flex items-center justify-center transition-colors"
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
