          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div
                ...
                className={`w-40 h-40 rounded-2xl bg-gradient-to-br from-[#252830] to-[#1a1a20] border border-white/[0.06] flex items-center justify-center overflow-hidden relative flex-shrink-0 ${isMine ? 'cursor-pointer' : ''}`}
              >
                {project.cover_url
