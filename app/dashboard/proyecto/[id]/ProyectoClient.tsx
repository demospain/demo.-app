...
export default function ProyectoClient({ project: initialProject, initialTracks, isMine, userId, nombre, inicial }: Props) {
  ...
  return (
    <div className={`flex flex-col min-h-screen ${currentTrack ? 'pb-20' : ''}`}>
      ...
      {/* Navbar */}
      <nav className="h-[72px] flex items-center justify-between px-8 sticky top-0 z-50 bg-[#0C0D0F]/95 backdrop-blur-sm">
        <div className="flex items-center gap-3 min-w-0">
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M10 3L5 8l5 5" stroke="#0C0D0F" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        ...
        <div className="flex items-center gap-2">
          {showSearch ? (
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <circle cx="7" cy="7" r="4.5" stroke="#0C0D0F" strokeWidth="1.6"/>
                <path d="M11 11l3 3" stroke="#0C0D0F" strokeWidth="1.6" strokeLinecap="round"/>
              </svg>
            </button>
          )}
            ...
            <button
              ...
              className={`w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${
                showSharePanel
                  ...
                  : 'bg-[#F8F7F4] hover:bg-white text-[#0C0D0F]'
              }`}
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
