  ...
  return (
    <div className="min-h-screen bg-[#0f1117]">
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        ...
        {/* Tarjeta horizontal de perfil */}
        <div className="bg-[#181c27] border border-white/[0.07] rounded-2xl p-6 mb-6">
          <div className="flex items-center gap-5">

            {/* Avatar */}
            <div className="w-16 h-16 rounded-xl bg-[#6E62F5] flex items-center justify-center text-xl font-bold text-white overflow-hidden flex-shrink-0">
              {profile.avatar_url
